...
const form = useForm({
    ...
    check_interval: props.domain.check_interval,
    timeout: props.domain.timeout,
    http_method: props.domain.http_method,
    expected_content: props.domain.expected_content || '',
    notify_channel: props.domain.notify_channel,
    is_active: props.domain.is_active,
    history_days: props.domain.history_days,
});
